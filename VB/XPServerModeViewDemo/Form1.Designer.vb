Namespace XPServerModeViewDemo
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.colPercentFromSalesByMonth = New DevExpress.XtraGrid.Columns.GridColumn()
			...
			Me.xpServerModeView1.Properties.AddRange(New DevExpress.Xpo.ServerViewProperty() {
				...
				New DevExpress.Xpo.ServerViewProperty("PercentFromSalesByMonth", DevExpress.Xpo.SortDirection.None, "[Quantity] * [Price] / [<Order>][GetYear([OrderDate]) = GetYear([^.OrderDate]) An" & "d GetMonth([OrderDate]) = GetMonth([^.OrderDate])].Sum([Quantity] * [Price]) * 1" & "00")
			})
			' 
			' gridView1
			' 
			Me.gridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() { Me.colOid, Me.colOrderDate, Me.colCustomer, Me.colProductName, Me.colPrice, Me.colQuantity, Me.colTotalPrice, Me.colPercentFromSalesByMonth})
			Me.gridView1.GridControl = Me.gridControl1
			Me.gridView1.GroupSummary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {
				New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "TotalPrice", Nothing, "(Total Price: SUM={0:0.##})"),
				New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Oid", Nothing, "(Count={0})")
			})
			...
			' 
			Me.colPercentFromSalesByMonth.Caption = "% from Sales by Month"
			Me.colPercentFromSalesByMonth.DisplayFormat.FormatString = "F3"
			Me.colPercentFromSalesByMonth.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
			Me.colPercentFromSalesByMonth.FieldName = "PercentFromSalesByMonth"
			Me.colPercentFromSalesByMonth.Name = "colPercentFromSalesByMonth"
			Me.colPercentFromSalesByMonth.Visible = True
			Me.colPercentFromSalesByMonth.VisibleIndex = 7
			' 
			' xtraTabPage2
			' 
			...
			' gridColumn8
			' 
			Me.gridColumn8.Caption = "% from Sales by Month"
			Me.gridColumn8.DisplayFormat.FormatString = "F3"
			Me.gridColumn8.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
			Me.gridColumn8.FieldName = "PercentFromSalesByMonth"
		...
		Private colPercentFromSalesByMonth As DevExpress.XtraGrid.Columns.GridColumn
